...
const MOCK_ADDRESSES: IAddress[] = [
  {
    ...
    ward: "Xã Cổ Đông",
    addressDetail: "36 Chợ Bãi Đá, Xã Cổ Đông, Thị xã Sơn Tây, Hà Nội, Vietnam",
    isDefault: true,
...
const MOCK_ITEMS: ICartItem[] = [
  {
    id: 1,
    variantId: 101,
    productName: "Áo thun local brand - Trắng",
    sku: "TSHIRT-WHITE-M",
    thumbnailUrl: "https://via.placeholder.com/150x150.png?text=Product+1",
    price: 199000,
    quantity: 2,
    total: 398000,
  },
  {
    id: 2,
    variantId: 202,
    productName: "Quần jean slimfit - Xanh đậm",
    sku: "JEAN-DARK-32",
    thumbnailUrl: "https://via.placeholder.com/150x150.png?text=Product+2",
    price: 399000,
    quantity: 1,
    total: 399000,
  },
...
export const CheckoutPage: React.FC = () => {
  ...
  const handlePlaceOrder = async () => {
    ...
    // Demo fix cứng: chỉ toast thông báo
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="flex-1 space-y-4">
            <CheckoutAddressSection
              ...
              onChangeAddress={() =>
                toast.info("Demo: chức năng thay đổi địa chỉ")
              }
            />
    ...
    <div className="bg-white rounded-xl shadow-sm">
      ...
      <div className="px-4 py-4 border-t space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <span className="text-sm text-slate-700">Phương thức vận chuyển</span>
    ...
    <div className="bg-white rounded-xl shadow-sm p-4">
      ...
      <div className="space-y-2">
        ...
        <label className="flex items-center gap-3 cursor-pointer">
          ...
          />
          <span className="text-sm text-slate-700">Thanh toán qua VNPay</span>
        </label>
      </div>
    ...
    <div className="bg-white rounded-xl shadow-sm p-4 sticky top-4">
      ...
      <p className="mt-2 text-xs text-slate-500">
        ...
        <span className="font-medium">
          {paymentMethod === "CASH" ? "Thanh toán khi nhận hàng" : "VNPay"}
        </span>
      </p>
