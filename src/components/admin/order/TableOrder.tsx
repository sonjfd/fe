            ...
            <div className="rounded-lg border bg-white">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        ...
                        {!loading &&
                            rows.map((o, idx) => {
                                const fee = o.ghnFee || 0;
                                // tổng thanh toán = tiền sau voucher + phí ship
                                const totalPayment = o.totalPrice + fee - (o.voucherDiscount ?? 0);
                        ...
                        >
                          {mapOrderStatus(o.orderStatus)}
                                        ...
                                        <td className="px-4 py-3">
                                            <button
                                                className="me-3 rounded border px-3 py-1.5 text-xs hover:bg-neutral-50"
                                                onClick={() => {
                                                    setDetailId(o.id);
                                                    setOpenDetail(true);
                                                }}
